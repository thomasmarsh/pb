...
public interface PlSqlParserListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link PlSqlParser#query_rewrite_clause}.
	 * @param ctx the parse tree
	 */
	void enterQuery_rewrite_clause(PlSqlParser.Query_rewrite_clauseContext ctx);
	/**
	 * Exit a parse tree produced by {@link PlSqlParser#query_rewrite_clause}.
	 * @param ctx the parse tree
	 */
	void exitQuery_rewrite_clause(PlSqlParser.Query_rewrite_clauseContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link PlSqlParser#sql_plus_filepath}.
	 * @param ctx the parse tree
	 */
	void enterSql_plus_filepath(PlSqlParser.Sql_plus_filepathContext ctx);
	/**
	 * Exit a parse tree produced by {@link PlSqlParser#sql_plus_filepath}.
	 * @param ctx the parse tree
	 */
	void exitSql_plus_filepath(PlSqlParser.Sql_plus_filepathContext ctx);
	/**
