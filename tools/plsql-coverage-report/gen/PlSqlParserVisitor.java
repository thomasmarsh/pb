...
public interface PlSqlParserVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link PlSqlParser#query_rewrite_clause}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitQuery_rewrite_clause(PlSqlParser.Query_rewrite_clauseContext ctx);
	/**
	 * Visit a parse tree produced by {@link PlSqlParser#unusable_editions_clause}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitUnusable_editions_clause(PlSqlParser.Unusable_editions_clauseContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link PlSqlParser#unary_expression_core}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitUnary_expression_core(PlSqlParser.Unary_expression_coreContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link PlSqlParser#sql_plus_filepath}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitSql_plus_filepath(PlSqlParser.Sql_plus_filepathContext ctx);
	/**
