"""Unit tests for pb_cli.shell.commands.clean."""

from __future__ import annotations

import pytest

from pb_cli.shell.commands import clean
...
def test_run_rejects_unknown_target(tmp_path, monkeypatch):
    monkeypatch.setattr("pb_cli.shell.commands.clean.env.build.find_repo", lambda repo: tmp_path)
