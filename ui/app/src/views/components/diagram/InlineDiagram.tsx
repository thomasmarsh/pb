...
import { stripSvgTitles, computeTooltipPosition, createPanZoom, DiagramTooltip } from "@pb/platform";

// Re-export pure functions for tests
export { computeZoom, smoothVelocity, stripSvgTitles, computeTooltipPosition, releaseVelocity, runMomentum, ZOOM_MIN, ZOOM_MAX } from "@pb/platform";
