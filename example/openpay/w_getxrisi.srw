...
// Αν δεν υπάρχουν χρήσεις άνοιγμα του w_createxrisi (wiz_setup)
...
event cb_ok::clicked;// Ενημερώνουμε τις καθολικές μεταβλητές χρήσης
// Ελέγχουμε αν η τρέχουσα ημ/νία είναι στα όρια της επιλεγμένης χρήσης
// και εμφανίζουμε μήνυμα
	long	ll_row
	ll_row = dw.getrow()
	if ll_row = 0 then 
