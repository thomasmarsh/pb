...
// autoupdate - Αν είναι true update when row changing
...
event clicked;// Επιλογή όλων των εγγραφών
...
event clicked;// Επιλογή της τρέχουσας εγγραφής
...
event clicked;// Μετακίνηση σε νέα εγγραφή
	long	ll_newrow
	ll_newrow = dw.rowcount()
	
	dw.SelectRow(0, false)	// Καθαρισμός επιλογής
...
event clicked;// Μετακίνηση στην τελευταία εγγραφή
...
event clicked;// Μετακίνηση στην επόμενη εγγραφή
// (αν δεν είμαστε στην τελευταία)
	...
	if ll_row = dw.rowcount() then return	// είμαστε στην τελευταία
...
event clicked;// Μετακίνηση στην προηγούμενη εγγραφή
...
event clicked;// Μετακίνηση στην πρώτη εγγραφή
...
event clicked;// Διαγραφή τρέχουσας εγγραφής ή όλων των επιλεγμένων
