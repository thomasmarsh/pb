...
event open;call super::open;// Παίρνουμε το initial string από Message
// Και το κάνουμε τίτλο στο παράθυρο
	is_title = Message.StringParm
	this.title = is_title
	
// Initialize dw_notes και εκχώρηση is_notes
...
event cb_cancel::clicked;// Επιστροφή ""
...
event cb_ok::clicked;// Επιστρέφουμε τις σημειώσεις μέσω Message
	dw_notes.accepttext()
