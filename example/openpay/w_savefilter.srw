...
// Ελέγχος αν δώσαμε όνομα φίλτρου
...
// Έλεγχος αν το όνομα του φίλτρου υπάρχει
	long		ll_count
	integer	li_ret
...
// Εισαγωγή του φίλτρου στον afxfilter
	long		ll_kodfilter
...
// Εισαγωγή των κριτηρίων στον afxFilterD
// (Όλες οι γραμμές του iw_filter.idw_filter εκτώς από την τελευταία (νέα))
