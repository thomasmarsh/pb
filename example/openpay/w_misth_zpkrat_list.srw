...
event me_create_yvar();// Δημιουργία μεταβλητής υπαλλήλου
...
// Παίρνουμε τον κωδικό και την περιγραφή του επιδόματος
// και ανοίγουμε τη φόρμα δημουργίας μεταβλητής υπαλλήλου
...
event me_create_epidom();// Δημιουργία αποδοχής - επιδόματος
...
// Παίρνουμε τον κωδικό και την περιγραφή της κράτησης
