...
type variables
protected 	string	is_select_form		// Το όνομα του παραθύρου για την δημιουργία where clause
...
event me_select();// Άνοιγμα του παραθύρου σχηματισμού where
	string ls_where
...
event doc_usage;// Εκτύπωση με τον σχηματισμό where από ένα σχετικό παράθυρο
// Inherit this και ορισμός του παραθύρου ορισμάτων is_select_form
// Optionally assign where string into descenant
// Το is_select_form επιστρέφει ένα string με την σχηματισμένη where
...
public function string if_openselect ();// Άνοιγμα του παραθύρου σχηματισμού της where
...
// Με το άνοιγμα παρουσιάζουμε την φόρμα για εισαγωγή κριτηρίων
	this.postevent("me_select")
end event

event ie_retrieve;call super::ie_retrieve;// Retrieve με την τρέχουσα is_where και is_order
