...
public function boolean of_next ();// Έλεγχος αν έχουμε επιλέξει τουλάχιστον μία μισθοδοσία
...
// Η νέα select ταξινομημένη κατά ημ/νία
	string	ls_order
