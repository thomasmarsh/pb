...
public subroutine fn_modify ();// Αλλάζουμε τις ρυθμίσεις του dw σύμφωνα με τις νέες τιμές
...
// Αν τροποποιήσαμε τις παραμέτρους του εκτυπωτή
// αλλάζουμε τη διάταξη και τη σελίδα
...
public subroutine fn_describe ();// Παίρνουμε τις ρυθμίσεις του idw_dw και ενημερώνουμε το παράθυρο
...
event open;call super::open;// Αποθηκεύουμε το dw
...
event close;call super::close;// Αν αλλάξαμε τον default εκτυπωτή τον επαναφέρουμε
