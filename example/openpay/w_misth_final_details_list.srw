...
event me_edit_print();// Εκτύπωση επιλεγμένης ατομικής μισθοδοσίας
...
// Μεταφορά στην gsc_misth_final_ypal
	of_reset_struct()
...
// Αν δεν υπάρχει άλλος καταχωρημένος υπάλληλος
// στην επιλεγμένη μισθοδοσία, διαγραφή και αυτής
	long	ll_count
