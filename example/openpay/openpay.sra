...
global variables
// application & version
	string	gs_lockfile				// Μυστικό αρχείο στο system
	String 	gs_ini_File
	string	gs_serialnumber		// βρίσκεται στο printer.cfg
	string	gs_app_name
...
// afxUsers
	...
	boolean					gb_useperm
	string					gs_kodapp		// Το είδος της εφαρμογής (από afxApps)
	
// popups
	m_popups	gpop
	
// dhmot variables
	string					gs_koddhmos		// Ο κωδικός του δήμου από param_genika
