...
// Αν το dw_perm δεν έχει εγγραφές, προσθέτουμε από τον usrActions
...
// descgroup
	...
	// Έλεγχος αν το descgroup υπάρχει (unique index)
		long	ll_count
...
// Προσθέτουμε εγγραφές στο idw_perm από usrActions
...
event open;call super::open;// Προσαρμογή τίτλου
	string	ls_title
	if ib_newrec then
		ls_title = trn(462)
	else
