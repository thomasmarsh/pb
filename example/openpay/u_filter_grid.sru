...
event ie_checkbuttons;call super::ie_checkbuttons;// Αν δεν υπάρχουν εγγραφές απενεργοποίηση της αποθήκευσης
	long	ll_rows
	ll_rows = dw.rowcount()
...
event clicked;// Έλεγχος καταχωρήσεων
...
// Άνοιγμα του w_savefilter για το is_tablename του parent
// Όλα γίνονται στο w_savefilter
...
event clicked;// Άνοιγμα του w_loadfilter με παράμετρο το iw_parent
// Όλες οι ενέργειες γίνονται στο w_loadfilter
