...
protected function boolean of_finish ();// Παίρνουμε όλα τα steps
...
// Παίρνουμε την ημ/νία απόδοσης και την περιγραφή
	date		ld_apoddate
...
// Εισάγουμε τα στοιχεία στον πίνακα misth_kratapod
	long	ll_kodkratapod
...
// Για κάθε επιλεγμένη μισθοδοσία
// update kodkratapod
...
// Μεταφορά στοιχείων στην gsc_misth_kratapod
