...
event doc_usege;// Δέχετα ένα string από Message ο οποίο είναι η where clause
// Optionally set order into descenant
// Προσοχή ώστε το dw να μην έχει where και order
end event
...
event ie_retrieve;call super::ie_retrieve;// Retrieve με την τρέχουσα is_where (optionally with order)
