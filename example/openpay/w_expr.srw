...
event open;call super::open;// Παίρνουμε τα δεδομένα
	s_expr	lsc_expr
...
string	ls_category
string	ls_var				// Η μεταβλητή, όπως δημιουργείται
...
choose case ls_category
	...
	case is_label_stath
		// Παίρνουμε τον κωδικό της σταθεράς και τον διαμορφώνουμε
			ls_var = this.object.kodvar[row]
			ls_var = " @" + ls_var + "@ "
			
	case is_label_yvar
		// Παίρνουμε τον κωδικό της μεταβλητής και τον διαμορφώνουμε
			ls_var = this.object.kodvar[row]
			ls_var = " #" + ls_var + "# "
			
	case is_label_epidom
		// Παίρνουμε τον κωδικό του επιδόματος και τον διαμορφώνουμε
			ls_var = this.object.kodvar[row]
			ls_var = " [" + ls_var + "] "
		
	case is_label_krat
		// Παίρνουμε τον κωδικό της κράτησης και τον διαμορφώνουμε
			ls_var = this.object.kodvar[row]
			ls_var = " {" + ls_var + "} "
...
// Γράφουμε την τιμή και αποεπιλέγουμε την γραμμή
...
event selectionchanged;// Αλλάζουμε το dw_var
