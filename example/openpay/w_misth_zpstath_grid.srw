...
event me_create_yvar();// Δημιουργία μεταβλητής υπαλλήλου με τα στοιχεία της σταθεράς

// Παίρνουμε την επιλεγμένη εγγραφή
	long		ll_row
...
// Παίρνουμε τον κωδικό και την περιγραφή της σταθεράς
// και ανοίγουμε τη φόρμα δημουργίας μεταβλητής
...
event me_create_epidom();// Δημιουργία επιδόματος με τα στοιχεία της σταθεράς
...
// Παίρνουμε τον κωδικό και την περιγραφή της σταθεράς
// και ανοίγουμε τη φόρμα δημουργίας επιδόματος
...
event me_create_krat();// Δημιουργία κράτησης με τα στοιχεία της σταθεράς
...
// Παίρνουμε τον κωδικό και την περιγραφή της σταθεράς
// και ανοίγουμε τη φόρμα δημουργίας κράτησης
...
// descstath
	...
	// Έλεγχος αν η περιγραφή υπάρχει
		...
		if ll_found > 0 and ll_found <> row then
			MessageBox(gs_app_name, "Αυτή η περιγραφή υπάρχει ήδη")
			adw.setfocus()
			adw.Setcolumn("descstath")
			return false
		end if			
